...
## 修改spi-nand的spi-max-frequency，原闪存104MHz对应52MHz，52000000，新闪存TC58CVG2S0HRAIJ闪存最大频率133MHz修改为104MHz，104000000
sed -i 's/spi-max-frequency = <52000000>/spi-max-frequency = <104000000>/' uboot-mtk-20220606/arch/arm/dts/mt7986a-redmi-ax6000.dts
